...
# i added this import to get chart working in pycharm
import matplotlib
...
# from .performance import performance as perf
import trending.statistics.performance as perf
...
class TearsheetStatistics(AbstractStatistics):
    ...
    def plot_results(self, filename=None):
        ...
        if filename is not None:
            fig.savefig(os.path.join(self.config.OUTPUT_DIR, filename), dpi=150, bbox_inches='tight')
