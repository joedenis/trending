...
"""
generates our data for a list of us stocks

need to download a large file from quandl
...
if __name__ == "__main__":
    ...
    our_tickers = get_list_tickers('/home/joe/PycharmProjects/trending/data')
    print(our_tickers)
